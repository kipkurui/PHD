...
function memechip {
	...
	meme-chip -oc $results/$cl-$tf-Maxtest -db $db -nmeme 500 -meme-nmotifs 5 -dreme-m 5 $derived/$tf-$cl.fa
...
do
	...
	do 
		for cl in Hepg2 K562 Helas3 T47d Shsy5y Imr90 A549 Nb4 Hct116 Hek293 Panc1 Mcf7 Gm12878 H1hesc 
		do
   			echo "doing $tf-$cl..."
			memechip
		#else
